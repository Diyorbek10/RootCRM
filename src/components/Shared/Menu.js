							...
							<div className="hleft">
								...
								<div className="dropdown">
									...
									<Link to="pageSearch" className="nav-link icon">
										<i className="fe fe-search" data-toggle="tooltip" data-placement="right" title="Qidiruv..."></i>
									</Link>
									<Link to="email" className="nav-link icon app_inbox">
										<i className="fe fe-user" data-toggle="tooltip" data-placement="right" title="Talaba qo'shish ..."></i>
									</Link>
									<Link to="filemanager" className="nav-link icon app_file xs-hide">
										<i className="fe fe-credit-card" data-toggle="tooltip" data-placement="right" title="To'lov qo'shish ..."></i>
									</Link>
									<Link to="socialMedia" className="nav-link icon xs-hide">
										<i className="fe fe-share-2" data-toggle="tooltip" data-placement="right" title="Lidlar ..."></i>
									</Link>
				 ...
				 */}
					...
					<div id="left-sidebar" className="sidebar">
						...
						<ul className="nav nav-tabs">
							<li className="nav-item"><span className={`nav-link ${!menuType ? ' active' : ''}`} data-toggle="tab" onClick={() => this.setState({ menuType: false })}> Bosh menu</span></li>
