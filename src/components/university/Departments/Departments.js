                      ...
                      <div className="row clearfix">
                        ...
                        <div className="col-sm-6">
                          <div className="form-group">
                            ...
                            >
                              <option value=""> </option>
                              <option value="Category 1">Javlonbek</option>
                              <option value="Category 2">John Doe</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div className="col-sm-6">
                          <div className="form-group">
                            ...
                            >
                              <option value=""> </option>
                              <option value="Category 1">Toq kunlar</option>
                              <option value="Category 2">Juft kunlar</option>
                              <option value="Category 3">Har kuni</option>
                              <option value="Category 3">Dam olish kuni</option>
                              <option value="Category 4">Boshqa</option>
                            </select>
                        ...
                        <div className="col-sm-6">
                          <div className="form-group">
                            ...
                            >
                              <option value=""> </option>
                              <option value="Category 1">Lyuks</option>
                              <option value="Category 2">404</option>
                            </select>
                          </div>
                        </div>
                        <div className="col-sm-6">
