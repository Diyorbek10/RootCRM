										...
										<div className="row clearfix">
											<div className="col-sm-6">
												<div className="form-group">
													<input type="text" className="form-control" placeholder="Bo'lim nomi " />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<input type="text" className="form-control" placeholder="Bo'lim Boshlig'i" />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
													<input type="number" className="form-control" placeholder="Talabalarning Soni " />
												</div>
											</div>
											<div className="col-sm-6">
												<div className="form-group">
											...
											<div className="col-sm-12">
												<button type="submit" className="mr-1 btn btn-primary">Yuborish</button>
												<button type="submit" className="btn btn-outline-secondary btn-default">Bekor qilish</button>
											</div>
										</div>
									</div>
								</div>
